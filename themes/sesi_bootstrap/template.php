 ...
 */
function sesi_bootstrap_bootstrap_based_theme() {
 ...
 */
function sesi_bootstrap_menu_tree__user_menu($variables) {
 ...
 */
function sesi_bootstrap_preprocess_views_view(&$vars) {
  $view = $vars['view'];
 ...
 */
function sesi_bootstrap_preprocess_html(&$variables) {
