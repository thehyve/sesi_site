...
namespace Search\VariableTermDto {

  class AggType extends \DrSlump\Protobuf\Enum {
    const MISSING = 0;
    const CARDINALITY = 1;
    const TERMS = 2;
    const STATS = 3;
...
namespace Search {
  ...
  class VariableTermDto extends \DrSlump\Protobuf\Message {
    ...
    /**  @var int - \Search\VariableTermDto\AggType */
    public $type = null;
    ...
    public static function descriptor()
    {
      ...
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\Search\VariableTermDto\AggType';
      $descriptor->addField($f);
     ...
     * Get <type> value
     *
     * @return int - \Search\VariableTermDto\AggType
     */
     ...
     * Set <type> value
     *
     * @param int - \Search\VariableTermDto\AggType $value
     * @return \Search\VariableTermDto
     */
...
namespace Search\FacetResultDto {
  ...
  class ValueResultDto extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Search.FacetResultDto.ValueResultDto');
     ...
     * Clear <key> value
     *
     * @return \Search\FacetResultDto\ValueResultDto
     */
...
namespace Search {
  ...
  class FacetResultDto extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \Search\FacetResultDto\ValueResultDto[]  */
    public $values = array();
    ...
    public static function descriptor()
    {
      ...
      // REPEATED MESSAGE values = 5
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 5;
      $f->name      = "values";
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $f->reference = '\Search\FacetResultDto\ValueResultDto';
      $descriptor->addField($f);
     ...
     * Set <values> value
     *
     * @param \Search\FacetResultDto\ValueResultDto $value
     * @return \Search\FacetResultDto
     */
    public function setValues(\Search\FacetResultDto\ValueResultDto $value, $idx = NULL){
     ...
     * @return \Search\FacetResultDto
     */
    public function addValues(\Search\FacetResultDto\ValueResultDto $value){
